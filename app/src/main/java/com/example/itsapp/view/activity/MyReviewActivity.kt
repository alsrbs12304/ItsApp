...
import com.example.itsapp.view.adapter.MyReviewAdapter
...
class MyReviewActivity : AppCompatActivity() {
    ...
    val MyReviewAdapter = MyReviewAdapter(reviewList)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        my_review_rv.adapter = MyReviewAdapter
        ...
        reviewViewModel.MyReviewLiveData.observe(this, Observer { reviewInfo ->
            if(reviewInfo.code.equals("200")) {
                ...
                MyReviewAdapter.updateItem(reviewInfo.jsonArray)
            }
        })
        ...
        reviewViewModel.MyReviewLiveData.observe(this, Observer { reviewInfo ->
            if(reviewInfo.code.equals("200")){
                MyReviewAdapter.setItemClickListener(object : MyReviewAdapter.OnItemClickListener{
